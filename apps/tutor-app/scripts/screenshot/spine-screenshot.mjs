...
await page.screenshot({ path: '/Users/haohe/Documents/code/codex/ai-english-tutor/apps/tutor-app/spine-screenshot-1.png', fullPage: false });
...
logs.filter(l => l.includes('Spine') || l.includes('Live2D') || l.includes('Character')).forEach(l => console.log(l));
