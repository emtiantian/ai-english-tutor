...
export const SessionsTable = defineTable(
  ...
  {
    indexes: [{ name: 'idx_sessions_user', columns: ['user_id'] }]
  }
)

export const UserVocabularyTable = defineTable(
  'user_vocabulary',
  {
...
export const ConversationHistoryTable = defineTable(
  ...
  {
    indexes: [{ name: 'idx_ch_session', columns: ['session_id'] }]
  }
)
