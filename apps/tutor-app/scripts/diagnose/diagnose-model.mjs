    ...
    setTimeout(() => {
      ...
      resolve({
        ...
        live2dCoreVersion: window.Live2DCubismCore ? 
          (window.Live2DCubismCore.Version ? 'has Version' : 'no Version') : 'no Live2DCubismCore',
        mocMethods: window.Live2DCubismCore && window.Live2DCubismCore.Moc ? 
          Object.keys(window.Live2DCubismCore.Moc) : [],
        versionMethods: window.Live2DCubismCore && window.Live2DCubismCore.Version ? 
