...
This project bundles three Live2D sample models copyrighted by **Live2D Inc.**
and distributed under the **Live2D Free Material License Agreement**.
...
These sample models are provided for **personal / educational use only** while bundled in this repository.
Before any commercial release (subscription, software sale, enterprise edition, etc.),
you **must** obtain a commercial license from Live2D Inc.
See [Live2D Sample Model Terms](https://www.live2d.com/eula/live2d-sample-model-terms_en.html) for details.

## Other Third-Party Software

See `LICENSE-Live2D.md` and individual package `package.json` files for additional third-party licenses.
